// ============================================================================
// ChatService+SummariesAndTitles.swift
// ============================================================================
// ChatService 的推理摘要、会话记忆摘要、快捷指令描述生成与会话标题生成。
// ============================================================================
...
extension ChatService {
    ...
    func performReasoningSummaryIfNeeded(for messageID: UUID, in sessionID: UUID, reasoning: String) async {
    ...
    func sanitizeReasoningSummaryText(_ rawSummary: String, maxLength: Int = 24) -> String {
    ...
    func applyReasoningSummary(_ summary: String, for messageID: UUID, in sessionID: UUID, expectedReasoning: String) {
    ...
    func performConversationMemoryUpdateIfNeeded(for sessionID: UUID, messages: [ChatMessage]) async {
    ...
    func updateConversationProfileIfNeeded(sessionID: UUID, latestSummary: String) async {
    ...
    func normalizedConversationMessagesForSummary(from messages: [ChatMessage]) -> [ChatMessage] {
    ...
    func makeConversationSummaryContext(from messages: [ChatMessage], messageLimit: Int = 12) -> String {
    ...
    func sanitizeConversationMemoryText(_ text: String, maxLength: Int) -> String {
        let normalized = text
            .trimmingCharacters(in: .whitespacesAndNewlines)
    ...
    func latestTwoRounds(from messages: [ChatMessage]) -> [ChatMessage] {
    ...
    func resolveTitleGenerationModel() -> RunnableModel? {
        let dedicatedModelIdentifier = UserDefaults.standard.string(forKey: Self.titleGenerationModelStorageKey) ?? ""
