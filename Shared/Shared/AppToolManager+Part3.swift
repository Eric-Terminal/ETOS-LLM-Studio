...
extension AppToolManager {
    ...
    nonisolated static func normalizedSandboxPathForComparison(_ rawPath: String) -> String? {
    ...
    nonisolated static func normalizedRequestID(_ rawValue: String?) -> String {
    ...
    nonisolated static func normalizedQuestionID(_ rawValue: String?, fallbackIndex: Int) -> String {
        normalizedOptionalText(rawValue) ?? "question_\(fallbackIndex + 1)"
    }

    nonisolated static func uniqueIdentifier(from candidate: String, seen: inout Set<String>) -> String {
    ...
    nonisolated static func normalizedOptionalText(_ rawValue: String?) -> String? {
