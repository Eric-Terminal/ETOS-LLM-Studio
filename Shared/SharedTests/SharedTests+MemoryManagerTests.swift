// ============================================================================
// SharedTests+MemoryManagerTests.swift
// ============================================================================
// MemoryManager 的增删改查、嵌入重试、重嵌入进度与关键词检索测试。
// ============================================================================
...
struct MemoryManagerTests {
    ...
    actor ProgressEventRecorder {
        var events: [MemoryEmbeddingProgress] = []
    ...
    func cleanup(memoryManager: MemoryManager) async {
