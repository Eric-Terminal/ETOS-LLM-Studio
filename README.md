...
*   **Apple 原生工具**：四组目录共包含 64 项设备、媒体与环境、个人数据、视觉与语言能力，按本机平台、系统版本和硬件显示。watchOS 不显示本机不支持的工具，也不通过 iPhone 代执行；天气、HomeKit、蓝牙等支持的能力在本机运行。写入或外部副作用仍需逐次审批。平台范围与开发者配置见[原生工具支持清单](docs/native-tools-support.md)。
