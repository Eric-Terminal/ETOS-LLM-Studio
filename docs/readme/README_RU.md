...
*   **Синхронизация и резервирование**: экспорт/импорт ETOS‑пакетов, полный импорт на watchOS, резервная копия при запуске и самовосстановление при повреждении, а также подписанная загрузка снимков в S3-совместимое объектное хранилище, например AWS S3 или Cloudflare R2.
