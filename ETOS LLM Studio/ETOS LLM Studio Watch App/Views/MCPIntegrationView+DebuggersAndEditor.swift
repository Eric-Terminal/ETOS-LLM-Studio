...
struct MCPToolDebuggerView: View {
    ...
    @State var payloadInput: String = "{}"
    @State var localError: String?
    @State var selectedServerID: UUID?
...
struct MCPServerEditor: View {
    ...
    let existingServer: MCPServerConfiguration?
    let onSave: (MCPServerConfiguration) -> Void
    
    @State var displayName: String
    @State var endpoint: String
    @State var sseEndpoint: String
    @State var apiKey: String
    @State var tokenEndpoint: String
    @State var clientID: String
    @State var clientSecret: String
    @State var oauthScope: String
    @State var oauthGrantType: MCPOAuthGrantType
    @State var oauthAuthorizationCode: String
    @State var oauthRedirectURI: String
    @State var oauthCodeVerifier: String
    @State var transportOption: TransportOption
    @State var notes: String
    @State var headerOverrideEntries: [HeaderOverrideEntry]
    ...
    func notesOrNil() -> String? {
        let trimmed = notes.trimmingCharacters(in: .whitespacesAndNewlines)
        return trimmed.isEmpty ? nil : trimmed
    }
    
    func oauthFieldsValid() -> Bool {
        if transportOption == .oauth {
    ...
    var headerOverridesHint: String {
    ...
    func addHeaderOverrideEntry() {
        headerOverrideEntries.append(HeaderOverrideEntry(text: ""))
    }

    func deleteHeaderOverrideEntries(at offsets: IndexSet) {
    ...
    func validateHeaderOverrideEntry(withId id: UUID) {
    ...
    func buildHeaderOverrides() -> [String: String]? {
    ...
    var headerOverridesPreview: HeaderOverridesPreview {
    ...
    func previewHeaderOverrides() -> (headers: [String: String], hasError: Bool) {
    ...
    func prettyPrintedJSON(_ headers: [String: String]) -> String {
...
struct HeaderOverrideEntry: Identifiable, Equatable {
    let id: UUID
    var text: String
    var error: String?
