// ============================================================================
// ETAdvancedMarkdownRenderer+MathWebViewHTMLShell.swift
// ============================================================================
// iOS 数学 WebView 渲染组件的 HTML 壳、样式与前端渲染脚本。
// ============================================================================
...
"""
        ...
        nonisolated static func cssFontFamily(role: FontSemanticRole, fallback: String) -> String {
        ...
        nonisolated static func cssRGBA(from hexRGBA: String?, alphaMultiplier: Double) -> String? {
