...
enum ETCodePreviewSupport {
    static let previewableLanguages: Set<String> = [
        "html", "htm", "xhtml", "xml", "svg"
    ]
    static func previewResetStyle(prefersDarkPalette: Bool) -> String {
...
"""
    ...
    static func wrappedHTMLIfNeeded(_ content: String, prefersDarkPalette: Bool) -> String {
...
"""
    ...
    static func injectingPreviewResetStyle(into html: String, prefersDarkPalette: Bool) -> String {
...
struct ETCodePreviewSheet: View {
    let content: String
    let language: String?
...
struct ETCodePreviewWebView: UIViewRepresentable {
...
enum ETCodeLanguage: Hashable {
    ...
    static let slashCommentLanguages: Set<ETCodeLanguage> = [.swift, .javascript, .typescript, .cstyle]
    static let hashCommentLanguages: Set<ETCodeLanguage> = [.python, .ruby, .bash, .data]
    static let backtickStringLanguages: Set<ETCodeLanguage> = [.javascript, .typescript]
    static let typeNameLanguages: Set<ETCodeLanguage> = [.swift, .typescript, .cstyle]
    static let propertyLanguages: Set<ETCodeLanguage> = [.swift, .javascript, .typescript, .python, .ruby, .cstyle]

    static let keywordTable: [ETCodeLanguage: Set<String>] = [
        .swift: [
...
struct ETCodeSyntaxHighlighter: CodeSyntaxHighlighter {
    ...
    func color(for token: TokenKind, palette: ETCodeHighlightPalette) -> Color {
        switch token {
        case .plain:
