// ============================================================================
// ChatView+MessageInfoSheet.swift
// ============================================================================
// iOS 聊天页的消息详情弹层、跳转输入与流式速度图表。
// ============================================================================
...
struct MessageInfoSheet: View {
    ...
    @State var jumpInput: String = ""
    @State var jumpError: String?
    ...
    /// 将消息角色转换为易读的中文描述
        func roleDescription(_ role: MessageRole) -> String {
            switch role {
            case .system:
    ...
    func formatSpeed(_ speed: Double, estimated: Bool) -> String {
...
struct MessageInfoStreamingSpeedChart: View {
    ...
    var samples: [MessageResponseMetrics.SpeedSample] {
    ...
    func smoothedLinePath(points: [CGPoint]) -> Path {
        var path = Path()
    ...
    func smoothedAreaPath(points: [CGPoint], height: CGFloat) -> Path {
